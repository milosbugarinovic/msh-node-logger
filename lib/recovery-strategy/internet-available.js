...
exports.InternetAvailable = void 0;
var base_recovery_strategy_1 = require("./base-recovery-strategy");
var internetAvailable = require('internet-available');
var InternetAvailable = /** @class */ (function (_super) {
    __extends(InternetAvailable, _super);
    function InternetAvailable(domainName, retryTimeout) {
        if (domainName === void 0) { domainName = 'google.com'; }
        if (retryTimeout === void 0) { retryTimeout = 4000; }
        var _this = _super.call(this) || this;
        _this.__isRecovering = false;
        _this.__retryTimout = retryTimeout;
        _this.__domainName = domainName;
        return _this;
    }
    InternetAvailable.prototype.onRecovered = function (cb) {
        this._addCallBackFunction(cb);
    };
    InternetAvailable.prototype.startRecovery = function () {
    ...
    InternetAvailable.prototype.__internetRecovered = function () {
        // console.log('InternetAvailable: internet recovered')
        this.__isRecovering = false;
        this._triggerAllCallBackFunction();
    };
    InternetAvailable.prototype.__checkUntilInternetAvailable = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, internetAvailable({
                                domainName: this.__domainName,
                                timeout: this.__retryTimout,
                            })
                                .then(function () {
                                _this.__internetRecovered();
                            })
                                .catch(function () {
...
exports.InternetAvailable = InternetAvailable;
//# sourceMappingURL=internet-available.js.map